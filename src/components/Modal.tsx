...
export default function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Card */}
      <div className={`relative bg-white w-full ${sizeClasses[size]} rounded-xl shadow-xl border border-gray-100 flex flex-col max-h-[90vh] overflow-hidden transform transition-all z-10 animate-in fade-in zoom-in-95 duration-200`}>
        {/* Header */}
